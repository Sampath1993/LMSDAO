...
public class GenreDAO extends BaseDAO {
	...
	public void saveBookGenre(Genre genre) throws SQLException {
		for(Book b: genre.getBooks()){
			save("INSERT INTO tbl_book_genres VALUES (?, ?)", new Object[] { b.getBookId(), genre.getGenreId()});
		}
	}
	...
	public List<Genre> extractData(ResultSet rs) throws SQLException {
		...
		while(rs.next()){
			...
			a.setBooks(bdao.readAllFirstLevel("SELECT * FROM tbl_genre WHERE genre_id IN (SELECT genre_id FROM tbl_book_genres WHERE genre_id = ?)", new Object[]{a.getGenreId()}));
			genres.add(a);
		}
